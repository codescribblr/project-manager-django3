...
class AccountInvite(TimeStampedModel, UUIDModel):
    """allows inviting collaborators on an Account"""
    account = models.ForeignKey(
        Account,
    ...
    email = models.EmailField(
        max_length=255,
        help_text='Email Address of invited member'
    )
    ...
    def __str__(self):
        return f'{self.email} on {self.created}'
